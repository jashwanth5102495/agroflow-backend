...
const creditAccountSchema = new mongoose_1.Schema({
    ...
    farmerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Farmer', required: true, unique: true },
    balance: { type: Number, default: 0 },
    lastUpdatedAt: { type: Date, default: Date.now },
}, { timestamps: true });
creditAccountSchema.index({ shopId: 1, farmerId: 1 }, { unique: true });
exports.CreditAccount = mongoose_1.default.model('CreditAccount', creditAccountSchema);
