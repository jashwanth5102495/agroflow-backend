...
const createPayment = async (req, res, next) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, payment, 'Payment created successfully', 201);
    }
    catch (error) {
        next(error);
    }
...
const getPayments = async (req, res, next) => {
    try {
        ...
        return (0, response_1.sendPaginatedSuccess)(res, payments, (0, pagination_1.formatPagination)(page, limit, total));
    }
    catch (error) {
        next(error);
    }
